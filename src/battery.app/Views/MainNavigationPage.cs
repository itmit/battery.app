...
{
	public class MainNavigationPage : TabbedPage, IFreshNavigationService
	{
		#region Data
		#region Fields
		/// <summary>
		...
		#region .ctor
		/// <summary>
		/// Инициализирует новый экземпляр <see cref="MainNavigationPage" />, регистрируя сервис навигации.
		/// </summary>
		public MainNavigationPage(string navigationServiceName)
		{
		...
		protected virtual Xamarin.Forms.Page CreateContainerPage(Xamarin.Forms.Page page) => new NavigationPage(page);
		#endregion
		...
		/// <param name="page">Изначальная страница.</param>
		/// <returns>Страница навигации.</returns>
		private Xamarin.Forms.Page CreateContainerPageSafe(Xamarin.Forms.Page page)
		{
